  ...
  return (
    <>
      <div className=" w-full flex min-h-[400px] max-h-1/2 h-full bg-secondary relative">
        <div className=" absolute right-10 aspect-[2.2/3] bottom-0 h-[300px] flex items-end justify-end z-3">
          <Image
        ...
        <div className="absolute aspect-[3.5/2] h-[200px] -rotate-12 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex items-end justify-end z-2">
          <Image
        ...
        <div className="absolute aspect-[3.5/2] h-[200px] rotate-12 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex items-end justify-end">
          <Image
