...
export const TransactionList = ({
  ...
  return (
    <section>
      <div className="container px-4 mx-auto gap-6 flex flex-col">
        <div className="flex justify-between">
          <p className="text-large font-medium ">Recent Transactions</p>
          <Button variant="link" className=" p-0 text-secondary">View all</Button>
        </div>
        <div className="flex flex-col divide-y w-full border-gray-200 gap-4">
          {transactions.map((tx) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className={`flex h-12 w-12 items-center justify-center rounded-md bg-accent/40`}
                >
                  {iconByType[tx.type]}
                </div>
                ...
                <div className="flex flex-col items-end justify-center space-y-1">
                  <span
                    className={`font-semibold text-lg ${amountColor} font-mono`}
                  >
